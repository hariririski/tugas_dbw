...
<?php
                  ...
                  include'maps/db.php';
                  $i=0; 
              $tampil2 = "SELECT * from kabupaten_kota,kecamatan,provinsi WHERE provinsi.id_provinsi and provinsi.id_provinsi=kabupaten_kota.id_provinsi and kabupaten_kota.id_kabupaten_kota=kecamatan.id_kabupaten_kota and kecamatan.id_kecamatan='$id'";
