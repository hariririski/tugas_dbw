...
<?php
                  ...
                  include'maps/db.php';
                  $i=0; 
                  $tampil2 = "SELECT * from kategori where id_kategori='$id'";
...
<div class="bs-docs-section mar-b-30">
  ...
  <h2 id="forms-horizontal">Edit Kategori</h2>
  ...
  <div class="bs-callout bs-callout-info">
    <form class="form-horizontal" role="form" action="proses/proses_tambah_kategori.php" method="POST" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="inputEmail3" placeholder="Nama Kategori" required name="nama_kategori" value="<?php echo $data2['nama_kategori']?>">
        </div>
      </div>
       ...
       <div class="form-group">
        ...
        <div class="col-sm-10">
		 <img src="maps/<?php echo $data2['icon']?>" width="50px">
