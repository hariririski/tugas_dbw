...
<![endif]-->
  ...
  <body>
    ...
    <!--breadcrumbs end-->
	<center> <a href="tambah_kategori.php" data-toggle="modal" data-target="#myModal"><button class="btn btn-primary btn-lg">Tambah Kategori</button><center></a>
    ...
    <?php
                  ...
                  while($data = mysqli_fetch_array($sql))
                   ...
                   <tr>
                    ...
                    <td class="center"><img src="maps/'.$data['icon'].'" width="50px"></td>
                    <td width="50px">
                   <a href="edit_kategori.php?id='.$data['id_kategori'].'" data-toggle="modal" data-target="#myModal"><button class="btn btn-primary">Edit</button></a>
				   </td>
				   <td width="50px">
					<a href="proses/proses_hapus_kategori.php?id= '.$data['id_kategori'].'"><button class="btn btn-danger ">Hapus</button></a>
                    </td>
