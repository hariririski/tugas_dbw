...
<?php
                  ...
                  include'maps/db.php';
                  $i=0; 
                  $tampil2 = "SELECT * from kabupaten_kota,provinsi WHERE provinsi.id_provinsi and provinsi.id_provinsi=kabupaten_kota.id_provinsi and kabupaten_kota.id_kabupaten_kota='$id'";
  ...
  <div class="bs-callout bs-callout-info">
    <form class="form-horizontal" role="form" action="proses/proses_tambah_kabupaten.php" method="POST">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="inputEmail3" placeholder="Nama Kabupaten" name="nama_kabupaten"required value="<?php echo $data2['nama_kabupaten_kota']?>">
        </div>
      </div>
    <div class="form-group">
